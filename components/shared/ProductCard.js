  ...
  return (
    <div className="flex flex-col gap-30px font-uncut group hover:font-snell">
      ...
      <div className="flex flex-col items-center ">
        <div className="text-sm uppercase font-semibold group-hover:font-snell group-hover:font-black group-hover:text-base group-hover:normal-case group-hover:leading-5">Pana Product 1</div>
        <div className="text-sm font-normal group-hover:font-uncut">IDR 200K</div>
      </div>
    </div>
  )
}
