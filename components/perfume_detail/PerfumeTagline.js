...
const PerfumeTagline = (props) => {
  return (
    <div className="relative ">
      ...
      <div className="z-index-30 w-full custom-text-120px absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white text-4xl font-uncut">
